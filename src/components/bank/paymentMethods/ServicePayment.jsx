            ...
            <div className="bg-white p-4 rounded-lg shadow-xl w-full max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="font-semibold mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-3 bg-gray-50">
                            {totalAmount.toLocaleString()} VND
                        </div>
                    </div>
                    <button
                        type="submit"
                        className="w-full bg-green-500 text-white py-3 rounded-lg shadow-lg hover:bg-green-600 transition duration-300 text-lg font-semibold"
                    >
                        Xác Nhận Thanh Toán
                    </button>
                </form>
