                ...
                <div className="bg-white rounded-lg shadow-xl w-full max-w-3xl">
                    ...
                    <div className="p-6 space-y-5">
                        <div className="text-gray-900">
                            ...
                            <p className="mb-4">
                                Vui lòng chuyển khoản Online LUÔN & NGAY cho E-Wallet.vn bằng 1 trong 2 phương tiện dưới
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="flex flex-col items-center p-4 border border-gray-200 rounded-lg">
                                    ...
                                    <p className="text-center">PHƯƠNG THỨC 1: Mở ứng dụng (Mobile App) Mobile Banking
                                        trên điện thoại</p>
                                </div>
                                <div className="flex flex-col items-center p-4 border border-gray-200 rounded-lg">
                                    <img src="/MSB_Web.png" alt="Internet Banking" className="max-w-full h-auto mb-2"/>
                                    <p className="text-center">PHƯƠNG THỨC 2: Đăng nhập vào Website Internet Banking của
                                        ngân hàng</p>
                                </div>
                            </div>
                            <p className="mt-4">
                                Hãy copy chính xác số tài khoản, nội dung chuyển khoản để Oggy E-Wallet ghi nhận giao dịch
                        ...
                        <div className="border p-4 rounded-lg bg-gray-50">
                            ...
                            <div className="space-y-2 flex flex-col items-center">
                                <img src="/qrCode.png" alt="QR Code" className="max-w-full h-auto w-auto mx-auto mb-2"/>
                    ...
                    {showProcessing && (
                        <div className="p-6 bg-gray-100 rounded-b-lg text-center">
                            ...
                            <p className="text-gray-600 max-w-md mx-auto">
                                Ngay khi nhận xác thực thành công từ phía Ngân hàng, chúng tôi sẽ gửi thông báo tới bạn!
                            </p>
