                    ...
                    {services.map((service, index) => {
                        ...
                        return (
                            <div key={index} className="flex flex-col items-center p-6 border rounded-lg shadow-md transition-transform transform hover:scale-105 hover:shadow-lg">
                                ...
                                <h3 className="text-xl font-semibold text-orange-500 mb-2 text-center">{service.title}</h3>
                    ...
                    {channels.map((channel, index) => {
                        ...
                        return (
                            <div key={index} className="flex items-start p-4 border rounded-lg shadow-md">
                                ...
                                <div>
                                    <h3 className="text-xl font-semibold text-orange-500 mb-2">{channel.title}</h3>
            ...
            <div className="mt-10 flex justify-center items-center">
                <div className="border-2 border-orange-500 rounded-lg p-6 flex justify-between items-center w-full max-w-4xl">
                    <p className="text-xl font-bold text-center">
                        <span className="text-orange-500 text-2xl">10</span> NĂM ĐỒNG HÀNH CÙNG <span className="text-orange-500 text-2xl">60.000</span> ĐỐI TÁC BÁN HÀNG VÀ THANH TOÁN TRÊN TOÀN QUỐC
                    </p>
