...
const Navbar = () => {
  ...
  return (
    <nav className="w-full h-20 items-center z-10 shadow bg-white fixed top-0 left-0 border-gray-200 dark:bg-gray-900">
      <div className="h-full w-full max-w-screen-xl flex items-center justify-between mx-auto p-4">
        ...
        <div className="h-full gap-2 flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
            className="h-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Get started
          </button>
          <button
